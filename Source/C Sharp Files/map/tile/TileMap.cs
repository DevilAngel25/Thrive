...
namespace MyGame.map.tile
{
    ...
    class TileMap
    {
        ...
        public int MapWidth = Options.Instance.WorldWidth;
        public int MapHeight = Options.Instance.WorldHeight;
        ...
        public TileMap(Texture2D mouseMap, Texture2D slopeMap)
        {
            ...
            //Biome Rules - Which Biomes are next to each other. 
            //Tile Rules - Which Tiles can be next to each other.
        ...
        public Point WorldToMapCell(Point worldPoint, out Point localPoint)
        {
            ...
            if (new Rectangle(0, 0, mouseMap.Width, mouseMap.Height).Contains(localPointX, localPointY))
            {
                ...
                //switch(myUint[0])
                //{ 
                //    case 0xFF0000FF: {dx = -1; dy = -1; localPointX += (mouseMap.Width / 2); localPointY += (mouseMap.Height / 2); break;}
                //    case 0xFF00FF00: {dx = -1; dy = 1; localPointX += (mouseMap.Width / 2); localPointY -= (mouseMap.Height / 2); break;}
                //    case 0xFF00FFFF: {dy = -1; localPointX -= (mouseMap.Width / 2); localPointY += (mouseMap.Height / 2); break;}
                //    case 0xFFFF0000: {dy = 1; localPointX -= (mouseMap.Width / 2); localPointY -= (mouseMap.Height / 2); break;}
                //}
